...
namespace DormitoryManagement.Controllers {
    public class ManagerController : Controller {
        ...
        public ActionResult ManageRoom(int? domId) {
            //kiểm tra trong session có phải là admin không
            if (Session["Account"] == null) { return Redirect("/Login"); }
            Account account = Session["Account"] as Account;
            if (!account.IsManager) { return Redirect("/Student"); }
        ...
        public ActionResult CreatePaymentRequest(string studentCode, int typeId, int? usage, DateTime deadline, string note) {
            ...
            int numberOfUse = 3000;
            double amount = (double)usage * numberOfUse;

            InvoiceDAO invoiceDao = new InvoiceDAO();
            bool r = invoiceDao.CreatePaymentRequest(student.Id, typeId, amount, usage, note, deadline);
            if (r) {
        ...
        /// <summary>
        /// Xem thong tin sinh vien 18/07/2021 
        /// </summary>
        /// <param name="page"></param>
        /// <param name="studentCode"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Xem chi tiet hoa don 18/07/2021 
        /// </summary>
        /// <param name="page"></param>
        /// <param name="studentCode"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Xem tat ca danh sach yeu cau cua sinh vien 18/07/2021 
        /// </summary>
        /// <param name="page"></param>
        /// <param name="studentCode"></param>
        /// <returns></returns>
